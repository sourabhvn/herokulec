...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file="E:\\lecmajorproj\\lecmajorproj\\back.png")
...
######################################## Home Page ####################################
tk.Label(pages[0], text="Law Enforcement Companion", fg="white", bg="orange",
      font="Arial 35 bold", pady=20).pack()

logo = tk.PhotoImage(file = "E:\\lecmajorproj\\lecmajorproj\\logo.png")
